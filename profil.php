...
if ($profilmodif == 1) {
    header('Location: profil_fini.php');
}
...
if (isset($_POST['confirm'])) {
    $rtt =$pdo->prepare('INSERT INTO pagepro (id_client,h1,bg_color,stickers1,stickers2,stickers3,stickers4,first_modif) VALUES(:id_client,:h1,:bg_color,:stickers1,:stickers2,:stickers3,:stickers4,1)');
    $rtt->bindParam(':id_client', $id);
    $rtt->bindParam(':bg_color', $_POST['bgcolor']);
    $rtt->bindParam(':h1', $_POST['colorh1']);
    $rtt->bindParam(':stickers1', $_POST['sticker1']);
    $rtt->bindParam(':stickers2', $_POST['sticker2']);
    $rtt->bindParam(':stickers3', $_POST['sticker3']);
    $rtt->bindParam(':stickers4', $_POST['sticker4']);
    $rtt->execute();
    header('Location: profil_fini.php');
...
<div class="container">
    <div class="row d-flex justify-content-between">
        <div class="col-2 "><img src="interface/lion.png" alt="..." width="130%;" id="pic1" data-toggle="modal" data-target="#exampleModalLong"></div>
        <div class="col-2 "><img src="interface/lion.png" alt="..." width="130%;" id="pic2" data-toggle="modal" data-target="#exampleModalLong1"></div>
        <div class="col-2"><img src="interface/lion.png" alt="..." width="130%;" id="pic3" data-toggle="modal" data-target="#exampleModalLong2"></div>
        <div class="col-2 "><img src="interface/lion.png" alt="..." width="130%;"  id="pic4" data-toggle="modal" data-target="#stikkk"></div>
