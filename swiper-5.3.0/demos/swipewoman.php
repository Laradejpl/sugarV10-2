...
<div class="swiper-container gallery-top mt-4">
    ...
    <?php foreach(Annoncesdernierpublier($pdo) as $post) : ?>
      <div class="swiper-slide " id="picswipe"  style="background-image:url(/../../../../assets/img/<?= $post['photo'] ?>);height:170%;">
      <a href="monProfil2.php?id=<?=  $post['id_membre']?>" class="btn btn-info btn-md">Voir</a>
      ...
      <h4 id="nameprofil" style="font-family: 'Sigmar One', cursive;color:white;text-shadow: 3px 3px #ff0000;"><?= $post['pseudo'] ?></h4><span style="font-family: 'Sigmar One', cursive;color:white;text-shadow: 3px 3px black;font-size:20px;"><?= $post['town']." ".$post['cp'] ?></span>
