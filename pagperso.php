...
//page quand c'est un profil visité
$req2 =$pdo->prepare("SELECT * FROM membre  WHERE id_membre= $idmembre");
$req2->execute();
$don = $req2->fetch(PDO::FETCH_OBJ);
$membrePage = $pdo->prepare("SELECT * FROM pagepro WHERE id_client= $idmembre");
$membrePage->execute();
$pageProfil = $membrePage->fetch(PDO::FETCH_OBJ);
//page quand c'est un profil visité
...
<style>
body{<?php echo $pageProfil->bg_color;?>}
.titl{<?php echo $pageProfil->h1;?>}
...
<?php if ($idmembre == getMembre()['id_membre']):?>
<div class="container ">
    <div class="row">
...
<div class="container">
    <div class="row d-flex justify-content-between">
        <div class="col-2 "><img src="<?php echo $pageProfil->stickers1 ;?>" alt="..." width="130%;" id="pic1" data-toggle="modal" data-target="#exampleModalLong"></div>
        <div class="col-2 "><img src="<?php echo $pageProfil->stickers2 ;?>"  alt="..." width="130%;" id="pic2" data-toggle="modal" data-target="#exampleModalLong1"></div>
        <div class="col-2"><img src="<?php echo $pageProfil->stickers3 ;?>"  alt="..." width="130%;" id="pic3" data-toggle="modal" data-target="#exampleModalLong2"></div>
        <div class="col-2 "><img src="<?php echo $pageProfil->stickers4 ;?>"  alt="..." width="130%;"  id="pic4" data-toggle="modal" data-target="#stikkk"></div>
