...
if (!empty($_GET['id'])) {
  ...
  $req = $pdo->prepare("SELECT * FROM user_kotlin_app WHERE id=?");
  ...
  if (!empty($_POST)) {
    ...
    $req1 = $pdo->prepare("DELETE FROM user_kotlin_app WHERE id = ? ");
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 red accent-4 mb-1"><h1 style="text-align:center;color:white;">Effacer .</h1></div>
    </div>
</div>
<br>
