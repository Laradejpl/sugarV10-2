...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 red accent-4 "><h3 style="text-align:center;color:white;">Les Ordinateurs</h3></div>
    </div>
</div>
...
<table class="table table-striped table-dark">
  ...
  <tbody>
  <?php
  $req = $pdo->query("SELECT * FROM products WHERE category_id=1");
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 teal accent-3 "><h3 style="text-align:center;color:white;">Les Ordinateurs Portables</h3></div>
    </div>
</div>
...
<table class="table table-striped table-dark">
  ...
  <tbody>
  <?php
  $req1 = $pdo->query("SELECT * FROM products WHERE category_id=2");
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12  lime accent-3 "><h3 style="text-align:center;color:white;">Les tablettes</h3></div>
    </div>
</div>
...
<table class="table table-striped table-dark">
  ...
  <tbody>
  <?php
  $req2 = $pdo->query("SELECT * FROM products WHERE category_id=3");
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12   green lighten-2 "><h3 style="text-align:center;color:white;">Les accessoires</h3></div>
    </div>
</div>
...
<table class="table table-striped table-dark">
  ...
  <tbody>
  <?php
  $req2 = $pdo->query("SELECT * FROM products WHERE category_id=4");
